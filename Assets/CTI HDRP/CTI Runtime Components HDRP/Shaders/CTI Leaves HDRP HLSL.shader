...
Shader "CTI HDRP/Leaves HSLS"
{
    Properties
    {
        ...
        _Thickness("Translucency", Float) = 1
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        float _Property_FF9E25F7_Out_0 = _TumbleStrength;
                        float _Property_8078A956_Out_0 = _TumbleFrequency;
                        float _Property_F08123F6_Out_0 = _LeafTurbulence;
                        float _Property_1F9E3672_Out_0 = _LeafNoise;
                        float3 _Property_350A65F6_Out_0 = _WindMultipliers;
                        Bindings_CTIWind_be4b42ff01448e24c8441bba8b2aceb8 _CTIWind_867EAC38;
                        _CTIWind_867EAC38.ObjectSpaceNormal = IN.ObjectSpaceNormal;
                        _CTIWind_867EAC38.ObjectSpacePosition = IN.ObjectSpacePosition;
                        _CTIWind_867EAC38.VertexColor = IN.VertexColor;
                        _CTIWind_867EAC38.uv1 = IN.uv1;
                        _CTIWind_867EAC38.uv2 = IN.uv2;
                        float3 _CTIWind_867EAC38_Position_1;
                        float3 _CTIWind_867EAC38_Normal_2;
                        float _CTIWind_867EAC38_ColorVariation_3;
                        SG_CTIWind_be4b42ff01448e24c8441bba8b2aceb8(_Property_FF9E25F7_Out_0, _Property_8078A956_Out_0, _Property_F08123F6_Out_0, _Property_1F9E3672_Out_0, _Property_350A65F6_Out_0, 0, _CTIWind_867EAC38, _CTIWind_867EAC38_Position_1, _CTIWind_867EAC38_Normal_2, _CTIWind_867EAC38_ColorVariation_3);
                        description.VertexPosition = _CTIWind_867EAC38_Position_1;
                        description.VertexNormal = _CTIWind_867EAC38_Normal_2;
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float4 _SampleTexture2D_24D4D091_RGBA_0 = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv0.xy);
                        float _SampleTexture2D_24D4D091_R_4 = _SampleTexture2D_24D4D091_RGBA_0.r;
                        float _SampleTexture2D_24D4D091_G_5 = _SampleTexture2D_24D4D091_RGBA_0.g;
                        float _SampleTexture2D_24D4D091_B_6 = _SampleTexture2D_24D4D091_RGBA_0.b;
                        float _SampleTexture2D_24D4D091_A_7 = _SampleTexture2D_24D4D091_RGBA_0.a;
                        float _Property_377C9C91_Out_0 = _CutOut;
                        surface.Alpha = _SampleTexture2D_24D4D091_A_7;
                        surface.AlphaClipThreshold = _Property_377C9C91_Out_0;
                        return surface;
                    }
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _SampleTexture2D_24D4D091_B_6 = _SampleTexture2D_24D4D091_RGBA_0.b;
                        float _SampleTexture2D_24D4D091_A_7 = _SampleTexture2D_24D4D091_RGBA_0.a;
                        float4 _SampleTexture2D_FABA819D_RGBA_0 = SAMPLE_TEXTURE2D(_BumpMap, sampler_BumpMap, IN.uv0.xy);
                        _SampleTexture2D_FABA819D_RGBA_0.rgb = UnpackNormal(_SampleTexture2D_FABA819D_RGBA_0);
                        float _SampleTexture2D_FABA819D_R_4 = _SampleTexture2D_FABA819D_RGBA_0.r;
                        float _SampleTexture2D_FABA819D_G_5 = _SampleTexture2D_FABA819D_RGBA_0.g;
                        float _SampleTexture2D_FABA819D_B_6 = _SampleTexture2D_FABA819D_RGBA_0.b;
                        float _SampleTexture2D_FABA819D_A_7 = _SampleTexture2D_FABA819D_RGBA_0.a;
                        float4 _SampleTexture2D_9F35E453_RGBA_0 = SAMPLE_TEXTURE2D(_TranslucencyMap, sampler_TranslucencyMap, IN.uv0.xy);
                        float _SampleTexture2D_9F35E453_R_4 = _SampleTexture2D_9F35E453_RGBA_0.r;
                        float _SampleTexture2D_9F35E453_G_5 = _SampleTexture2D_9F35E453_RGBA_0.g;
                        float _SampleTexture2D_9F35E453_B_6 = _SampleTexture2D_9F35E453_RGBA_0.b;
                        float _SampleTexture2D_9F35E453_A_7 = _SampleTexture2D_9F35E453_RGBA_0.a;
                        float _Property_B594E254_Out_0 = _Thickness;
                        float _Multiply_A271448E_Out_2;
                        Unity_Multiply_float(_SampleTexture2D_9F35E453_B_6, _Property_B594E254_Out_0, _Multiply_A271448E_Out_2);
                        float _OneMinus_5E392D06_Out_1;
                        Unity_OneMinus_float(_Multiply_A271448E_Out_2, _OneMinus_5E392D06_Out_1);
                        float _Split_3C9969E9_R_1 = IN.VertexColor[0];
                        float _Split_3C9969E9_G_2 = IN.VertexColor[1];
                        float _Split_3C9969E9_B_3 = IN.VertexColor[2];
                        float _Split_3C9969E9_A_4 = IN.VertexColor[3];
                        float _Property_377C9C91_Out_0 = _CutOut;
                        surface.Albedo = (_SampleTexture2D_24D4D091_RGBA_0.xyz);
                        surface.Normal = (_SampleTexture2D_FABA819D_RGBA_0.xyz);
                        surface.BentNormal = IN.TangentSpaceNormal;
                        surface.Thickness = _OneMinus_5E392D06_Out_1;
                        surface.DiffusionProfileHash = _DiffusionProfileHash;
                        surface.CoatMask = 0;
                        surface.Emission = float3(0, 0, 0);
                        surface.Smoothness = _SampleTexture2D_9F35E453_A_7;
                        surface.Occlusion = _Split_3C9969E9_A_4;
                        surface.Alpha = _SampleTexture2D_24D4D091_A_7;
                        surface.AlphaClipThreshold = _Property_377C9C91_Out_0;
                        return surface;
                    }
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        surface.CoatMask = 0;
                        surface.Emission = float3(0, 0, 0);
                        surface.Smoothness = _SampleTexture2D_9F35E453_A_7 * _Smoothness;
                        surface.Occlusion = IN.VertexColor[3];
                        surface.Alpha = _SampleTexture2D_24D4D091_A_7;
                        surface.AlphaClipThreshold = _Property_377C9C91_Out_0;
                        return surface;
                    }
